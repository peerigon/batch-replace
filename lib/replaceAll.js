...
var And = Object.create(replaceAll),
    With = {};
...
replaceAll.module = function (name, module) {
    replaceAll[name] = function () {
        replaceAll._queue.push(module);
        return And;
    };
 ...
 * @returns {Object}
 */
And.and = function (pattern) {
    replaceAll._queue.push({
        pattern: pattern
    });
 ...
 * @returns {Object}
 */
With["with"] = function (replace) {
    replaceAll._queue[replaceAll._queue.length - 1].replace = replace;
